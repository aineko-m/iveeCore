...
MyDefaults serves as examplos of the intended way of extending iveeCore.
...
```
This will fetch the newest relevant data from CREST. This script should be run every few hours so your system industry indices are up-to-date. They do change over the course of a day.
