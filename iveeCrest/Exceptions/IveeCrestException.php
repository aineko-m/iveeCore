 ...
 * @link     https://github.com/aineko-m/iveeCrest/blob/master/iveeCrest/Exceptions/iveeCrestException.php
 */

namespace iveeCrest\Exceptions;

/**
 * Base class for all iveeCrest exception, also thrown when a general application error occurs.
 *
 * @category IveeCrest
 * @package  IveeCrestExceptions
 * @author   Aineko Macx <ai@sknop.net>
