...
class EmdrConsumer {
    ...
    protected function __construct(){
        ...
        $res = $sde->query("SELECT 
            ...
            LEFT JOIN (
                ...
                newestPriceData, 
                lastPriceUpdate 
                FROM iveeTrackedPrices WHERE regionID = " . (int) $sde->defaults->getDefaultRegionID() . "
    ...
    public function run(){
        ...
        $defaultRegionID = SDE::instance()->defaults->getDefaultRegionID();
